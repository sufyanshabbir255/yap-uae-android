...
public class LegendRenderer extends Renderer {
    ...
    public LegendRenderer(ViewPortHandler viewPortHandler, Legend legend) {
        ...
        mLegendLabelPaint.setTextSize(UtilsPieView.convertDpToPixel(9f));
    ...
    public void renderLegend(Canvas c) {
        ...
        float labelLineHeight = UtilsPieView.getLineHeight(mLegendLabelPaint, legendFontMetrics);
        float labelLineSpacing = UtilsPieView.getLineSpacing(mLegendLabelPaint, legendFontMetrics)
                + UtilsPieView.convertDpToPixel(mLegend.getYEntrySpace());
        float formYOffset = labelLineHeight - UtilsPieView.calcTextHeight(mLegendLabelPaint, "ABC") / 2.f;

        LegendEntry[] entries = mLegend.getEntries();

        float formToTextSpace = UtilsPieView.convertDpToPixel(mLegend.getFormToTextSpace());
        float xEntrySpace = UtilsPieView.convertDpToPixel(mLegend.getXEntrySpace());
        ...
        float defaultFormSize = UtilsPieView.convertDpToPixel(mLegend.getFormSize());

        // space between the entries
        float stackSpace = UtilsPieView.convertDpToPixel(mLegend.getStackSpace());
        ...
        switch (orientation) {
            case HORIZONTAL: {
                ...
                for (int i = 0, count = entries.length; i < count; i++) {
                    ...
                    float formSize = Float.isNaN(e.formSize) ? defaultFormSize : UtilsPieView.convertDpToPixel(e.formSize);
            ...
            case VERTICAL: {
                ...
                for (int i = 0; i < entries.length; i++) {
                    ...
                    if (e.label != null) {
                        ...
                        if (direction == Legend.LegendDirection.RIGHT_TO_LEFT)
                            posX -= UtilsPieView.calcTextWidth(mLegendLabelPaint, e.label);
    ...
    protected void drawForm(
        ...
        switch (form) {
            ...
            case LINE:
            {
                final float formLineWidth = UtilsPieView.convertDpToPixel(
