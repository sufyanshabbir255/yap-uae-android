...
public class XAxisRenderer extends AxisRenderer {
    ...
    public XAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans) {
        ...
        mAxisLabelPaint.setTextSize(UtilsPieView.convertDpToPixel(10f));
    }
    ...
    protected void computeSize() {
        ...
        final FSize labelSize = UtilsPieView.calcTextSize(mAxisLabelPaint, longest);

        final float labelWidth = labelSize.width;
        final float labelHeight = UtilsPieView.calcTextHeight(mAxisLabelPaint, "Q");

        final FSize labelRotatedSize = UtilsPieView.getSizeOfRotatedRectangleByDegrees(
                labelWidth,
                labelHeight,
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                if (mXAxis.isAvoidFirstLastClippingEnabled()) {
                    ...
                    if (i / 2 == mXAxis.mEntryCount - 1 && mXAxis.mEntryCount > 1) {
                        float width = UtilsPieView.calcTextWidth(mAxisLabelPaint, label);
    ...
    protected void drawLabel(Canvas c, String formattedLabel, float x, float y, MPPointF anchor, float angleDegrees) {
        UtilsPieView.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees);
    }
    ...
    public void renderLimitLineLabel(Canvas c, LimitLine limitLine, float[] position, float yOffset) {
        ...
        if (label != null && !label.equals("")) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                final float labelLineHeight = UtilsPieView.calcTextHeight(mLimitLinePaint, label);
