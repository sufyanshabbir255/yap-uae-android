 ...
 */
class SingleTextViewHolderArrayAdapter<T>
 ...
 */
(context: Context, @LayoutRes private val layoutRes: Int, objects: List<T>) : ViewHolderArrayAdapter<T, TextViewHolder<T>, TextViewHolder<T>>(context, objects, { parent ->
