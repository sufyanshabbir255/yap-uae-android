...
/**
 * PopupMenu is one the implementation of the {@link AbstractPowerMenu}.
 *
 * <p>It implements the popup showing with the item selected effect by {@link MenuListAdapter}.
 *
 * <p>{@link PopupMenuItem} is the member of the PopupMenu's list.
 */
@SuppressWarnings("unused")
public class PopupMenu extends AbstractPowerMenu<PopupMenuItem, MenuListAdapter>
    implements IPopupMenuAdapter {

  private PopupMenu(@NonNull Context context, @NonNull AbstractMenuBuilder abstractMenuBuilder) {
    ...
    addItemList(builder.popupMenuItems);
  }
  ...
  /** Builder class for creating {@link PopupMenu}. */
//  @PowerMenuDsl
  public static class Builder extends AbstractMenuBuilder {

    private OnMenuItemClickListener<PopupMenuItem> menuItemClickListener = null;
    ...
    public Builder setOnMenuItemClickListener(
        OnMenuItemClickListener<PopupMenuItem> menuItemClickListener) {
    ...
    /**
     * adds an {@link PopupMenuItem} item to the popup menu list.
     *
     * @param item {@link PopupMenuItem} item.
     * @return {@link Builder}.
     */
    public Builder addItem(PopupMenuItem item) {
      this.popupMenuItems.add(item);
      return this;
    }

    /**
     * adds an {@link PopupMenuItem} item to the popup menu list at position.
     *
     * @param position specific position.
     * @param item {@link PopupMenuItem} item.
     * @return {@link Builder}.
     */
    public Builder addItem(int position, PopupMenuItem item) {
      this.popupMenuItems.add(position, item);
      return this;
    }

    /**
     * adds a list of the {@link PopupMenuItem} item to the popup menu list.
     *
     * @param itemList list of the {@link PopupMenuItem}.
     * @return {@link Builder}.
     */
    public Builder addItemList(List<PopupMenuItem> itemList) {
      this.popupMenuItems.addAll(itemList);
      return this;
    }
  ...
  /**
   * An abstract factory class for creating an instance of {@link PopupMenu}.
   *
   * <p>A factory implementation class must have a non-argument constructor.
   */
  public abstract static class Factory {

    /** returns an instance of {@link PopupMenu}. */
