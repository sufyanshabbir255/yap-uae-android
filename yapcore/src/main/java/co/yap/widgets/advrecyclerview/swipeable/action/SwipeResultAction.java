...
package co.yap.widgets.advrecyclerview.swipeable.action;
...
public abstract class SwipeResultAction {
    ...
    /**
     * This method is called immediately after returning from the {@link co.yap.widgets.advrecyclerview.swipeable.SwipeableItemAdapter#onSwipeItem(RecyclerView.ViewHolder, int, int)} method.
