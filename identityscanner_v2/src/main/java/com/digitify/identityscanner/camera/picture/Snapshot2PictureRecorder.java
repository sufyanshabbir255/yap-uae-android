...
import com.digitify.identityscanner.camera.engine.lock.LockAction;
...
public class Snapshot2PictureRecorder extends SnapshotGlPictureRecorder {
    ...
    public Snapshot2PictureRecorder(@NonNull PictureResult.Stub stub,
        ...
        mAction = Actions.INSTANCE.sequence(
                Actions.INSTANCE.timeout(LOCK_TIMEOUT, new LockAction()),
                new FlashAction());
